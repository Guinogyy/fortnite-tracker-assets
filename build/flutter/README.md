...
* `tracker_fortnite` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `tracker-fortnite` - executable or bundle name on disk.
* `tracker-fortnite` - display name shown in window titles and about app dialogs.
